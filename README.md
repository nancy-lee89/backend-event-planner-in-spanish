...
This application uses SQL Alchemy and stores data on Heroku to create two tables. One holds information about people who are interested in [subscribing](https://backend-event-planner-spanish.herokuapp.com/contact_info) to the newsletter and the other table is to store information about [events](https://backend-event-planner-spanish.herokuapp.com/event_info). Lastly uses routes to send and modify the information in the database. This application was deployed on Heroku. 
